...
class Config:
    ...
    def configInit(self):
        ...
        global_config.set_value(
            'ip_config.dir', config.get('ip_config', 'dir'))
        global_config.set_value(
            'ip_config.name', config.get('ip_config', 'name'))
        global_config.set_value(
            'ip_config.url', config.get('ip_config', 'url'))
        ...
        global_config.set_value("log.dir", config.get('log', 'dir'))
